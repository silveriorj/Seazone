...
from Seazone.spiders.reccomends import ReccomendAir
from Seazone.spiders.reccomends import ReccomendViva
from Seazone.spiders.reccomends import Tendencia

# URL's NECESSÁRIAS (INCLUINDO FILTROS)
#AIR_URL_JURERE = '/s/Jurerê--Florianópolis-~-SC/homes?refinement_paths%5B%5D=%2Fhomes&current_tab_id=home_tab&selected_tab_id=home_tab&screen_size=large&search_type=filter_change&place_id=ChIJAwAnTFxEJ5UR-7iZMcQJ8I0&hide_dates_and_guests_filters=true&map_toggle=false&source=structured_search_input_header&adults=4&min_bedrooms=2'
#AIR_URL_JURERE_INTERNACIONAL = '/s/Jurerê-Internacional--Florianópolis-~-SC/homes?refinement_paths%5B%5D=%2Fhomes&current_tab_id=home_tab&selected_tab_id=home_tab&screen_size=medium&search_type=pagination&map_toggle=false&source=structured_search_input_header&place_id=ChIJEdpFl_lEJ5URh3hkEEmIlVc&hide_dates_and_guests_filters=true&s_tag=V5gl7d_Q&adults=4&min_bedrooms=2&last_search_session_id=fced69c5-c226-4e10-81f4-e66f10e5311c'
